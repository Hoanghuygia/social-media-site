...
function SigninForm(props) {
    const colorOr = { color: "#A3A3A3" };
    const colorButton = { color: "#555555" };
    const colorSigin = { color: "#7F7F7F" };
    ...
    const initialValues = {
        ...
        year: "1990",
        gender: "",
        profilePicture: "/img/avatar.png",  // Default profile picture
    };
            ...
            try {
                const response = await fetch('https://sugar-cube.onrender.com/register', {
                    ...
                    body: JSON.stringify({
                        ...
                        profilePicture: formValues.profilePicture,  // Include profile picture
                    })
                });
            ...
            <form action="" className="w-full h-full" onSubmit={handleSubmit}>
                <div className="rounded-3xl shadow-xl">
                    <div className="text-center	text-xl font-bold pt-5" style={colorSigin}>
                        <p>Sign in to share your sweet with</p>
                    </div>
                    ...
                    <div className="relative w-full text-center">
                        <div className="relative inline-block w-[41%] ml-auto mr-auto mb-4">
                            <input
                                ...
                                className="placeholder:font-bold placeholder:text-slate-400 w-full h-[10%] bg-white border-none outline-none rounded-full pt-4 pl-7 pr-5 pb-4 shadow-inner shadow-gray-400"
                            />
                        </div>
                        ...
                        <div className="relative inline-block w-[41%] ml-auto mr-auto mb-4">
                            <input
                                ...
                                className="placeholder:font-bold placeholder:text-slate-400 w-full h-full bg-white border-none outline-none rounded-full pt-4 pl-7 pr-5 pb-4 shadow-inner shadow-gray-400"
                            />
                        </div>
                    </div>
                    ...
                    <div className="relative w-full text-center mb-3">
                        ...
                        <div className="relative inline-block w-[12.5%] ml-auto mr-auto">
                            <select
                                onChange={handleChange}
                                id="day"
                                className="appearance-auto font-bold text-slate-400 w-full h-full bg-white border-none outline-none rounded-full pt-2 pl-2 pr-1 pb-2 shadow-inner shadow-gray-400"
                            >
                                {days.map((day) => (
                ...
                <button
                    type="submit"
                    className="block relative w-4/5 h-16 ml-auto mr-auto mt-6 border-none outline-none cursor-pointer rounded-full text-2xl font-bold bg-rose-200 hover:bg-rose-300"
                    style={colorButton}
                >
                    Sign in
                </button>
